 ...
 * @author dmgouriev
 */
public class EyeTVStick extends CxUsbDvbDevice {
    public final static String DVB_NAME = "EyeTV Stick/T2/C";
    final static DeviceFilter EyeTVStick = new DeviceFilter(DvbUsbIds.USB_VID_CONEXANT, DvbUsbIds.USB_PID_EyeTVStick, DVB_NAME);

    private Si2168 frontend;

    EyeTVStick(UsbDevice usbDevice, Context context) throws DvbException {
        super(usbDevice, context, EyeTVStick);
    }
